...
public class UserController {
 ...
 //       return userModelRepository.findAll();
    ...
    public User createUser(@RequestBody @Parameter(description = "Info of user. Id and pwd should be anonimized")  User user) {
...
//    
    ...
    @Operation(summary = "Get all the users proeprties by user name")
